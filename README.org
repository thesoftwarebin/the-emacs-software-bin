...
My scripts and tiny programs for Emacs.
  ...
  - [[file:learnjap/learnjap.el][learnjap.el]] - tells you the meaning and readings of a kanji, and reading of hiragana/katakana; download the =.el= files in the [[file:learnjap][learnjap directory]], load them with =M-x load-file RET learnjap.el RET= and read the docstrings with =C-f learnjap/show-learnjap-info RET=
