...
My scripts and tiny programs for Emacs.
  ...
  - [[file:include-all-org-files/include-all-org-files.el][include-all-org-files.el]] - an Org Babel block that adds =#+INCLUDE:= tags for all the =.org= files of a directory
