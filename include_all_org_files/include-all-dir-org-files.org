...
#+COMMENT:  
#+COMMENT: `include-all-dir-org-files' is a Babel CALLable block who can generate a list of #+INCLUDE statements;
...
#+COMMENT:
#+COMMENT: Before CALLing include-all-dir-org-files, you should a) copy its definition (the #+BEGIN_SRC/#+END_SRC
#+COMMENT: block) into your org file, or alternatively b) you could include it in your Babel Library:
#+COMMENT:
#+COMMENT: M-x org-babel-lob-ingest RET <the_include_all_dir_filename> RET
#+COMMENT:
#+COMMENT: Synopsis:
#+COMMENT:
#+COMMENT:   #+CALL: include-all-dir-org-files(i_level=<nubmer>, i_name=<string>, i_dir=<string>) :exports none :results raw
#+COMMENT:
...
#+COMMENT:                      `#+INCLUDE' filenames; use it when you #+CALL include-all-dir-org-files
...
#+NAME: include-all-dir-org-files
